...
>
  ...
  `}
                                        ...
                                        <div className="flex items-center justify-center opacity-50 w-full">
                                            <FaUsers
                                                className={`text-3xl mr-2 ${theme === "Dark" ? "text-white" : "text-black"
                                                    }`}
                                            />
                            ...
                            <div className="grid grid-cols-1 gap-3 overflow-y-auto pr-2">
                                {filteredTickets && filteredTickets.length ? (
                                    ...
                                    <div className="text-center opacity-50 mt-4">
                                        <FaExclamationCircle
                                            className={`text-3xl mx-auto ${theme === "Dark" ? "text-white" : "text-black"
                                                }`}
                                        />
                                        <p className="text-sm mt-2">Select Employee / No Debts</p>
                                    </div>
                                )}
                            </div>
                        </div>
